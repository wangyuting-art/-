...
(function ($, learun) {
    ...
    $.fn.lrLayout = function (op) {
        ...
        $this.hasClass("lr-layout lr-layout-left-center") || $this.addClass("lr-layout lr-layout-left-center");

        if ($this.children(".lr-layout-left").length <= 0) {
            $this.html('<div class="lr-layout-left"><div class="lr-layout-wrap"></div></div><div class="lr-layout-center"><div class="lr-layout-wrap"></div></div>');
        }
