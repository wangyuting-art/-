layui.define(['jquery'], function (exports) {
    ...
    tree.prototype.template = function (e) {
        var t = this,
            ...
            thead = checkbox && '<th style="width:'+e.checkbox_col_width+'px;">' + (o.inArray(e.top_value, e.checked.data) > -1 ? checked : checkbox) + '</th>';

        // update by xsq 2019.9.9
        // 生成表头
        ...
        o.each(t.data(e, e.data), function (idx, item) {
            ...
            var box = is_table ? o(is_checked ? checked : checkbox).wrap('<td style="width:'+e.checkbox_col_width+'px;">').parent().prop('outerHTML') : '';
